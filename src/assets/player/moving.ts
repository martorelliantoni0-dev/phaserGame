  ...
  export default class playerr extends Phaser.Physics.Arcade.Sprite {
    ...
    constructor(scene: Phaser.Scene, x: number, y: number) {
      ...
      scene.anims.create({
        ...
        frames: scene.anims.generateFrameNumbers("tipa", { start: 9, end: 17 }),
        frameRate: 9,
        repeat: -1
      });
      ...
      scene.anims.create({
        ...
        frames: scene.anims.generateFrameNumbers("tipa", { start: 27, end: 35 }),
        frameRate: 9,
        repeat: -1
      });
      ...
      scene.anims.create({
        ...
        frames: scene.anims.generateFrameNumbers("tipa", { start: 0, end: 8 }),
        frameRate: 9,
        repeat: -1
      });
      ...
      scene.anims.create({
        ...
        frames: scene.anims.generateFrameNumbers("tipa", { start: 18, end: 26 }),
        frameRate: 9,
        repeat: -1
      });
